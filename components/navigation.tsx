...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] bg-background/95 backdrop-blur-xl">
          ...
          <div className="h-full flex flex-col items-center justify-center space-y-8">
            {navItems.map((item) => (
              <a
                ...
                href={item.href}
                onClick={() => setIsOpen(false)}
                className="text-2xl font-light tracking-wide text-foreground hover:opacity-70 transition"
              >
                {item.label}
              </a>
            ))}
